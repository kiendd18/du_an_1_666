...
<div id="quen-modal" class="modal">
  <div class="modal-content">
    <span class="close" id="close_quen">×</span>
    <h2>Quên mật khẩu</h2>
    <form id="forgotPasswordForm" method="post" action="index.php?action=quenmk">
      <div class="form-group">
        <label for="forgot-email">Email *</label>
        <input type="email" name="email" id="forgot-email" placeholder="Your email" required />
      </div>
      ...
      <form action="" method="post">
        <div class="row-col-2 order">
          <div class="order-info-left">
                ...
                <?php foreach ($_SESSION['cart'] as $key => $value): ?>
                  ...
                  <div class="favoriteProduct-info order">
                    ...
                    <div class="favoriteProduct-details">
                      <a href="/du_an1/product_detail&product_id=<?= $value['product_id'] ?>"
                        class="favoriteProduct-link"><?= $value['product_name'] ?></a>
                      <div class="favoriteProduct-option">
                        ...
                        <div class="favoriteProduct-inc">
                          <span id="cart_product_id" color_name_id="<?= $value['colorNameId'] ?>"
                            size_id="<?= $value['sizeId'] ?>" product_id="<?= $value['product_id'] ?>"></span>
                          <i class="fa-solid fa-minus cartModal-inc-minus" id="cartModal-inc-minus"></i>
                          <input type="number" disabled value="<?= $value['quantity'] ?>"
                            class="favoriteProduct-inc-quantity"
                            idcz="<?= "i" . $value['product_id'] . "C" . $value['colorNameId'] . "Z" . $value['sizeId'] ?>" />
            ...
            <button type="button" id="auto__fill__btn" <?= !isset($_SESSION['username']) ? 'hidden' : ''; ?>>Tự động
              điền</button>
            <input type="hidden" id="customer_id"
              value="<?= isset($_SESSION['username']) ? $_SESSION['username']['id'] : '' ?>">
            ...
            <div class="checkout__input">
              ...
              <textarea name="" id="customerNote" cols="30" rows="8" placeholder="Ghi chú về đơn đặt hàng của bạn"
                style="width:100%;resize: none;border:1px solid  #ebebeb"></textarea>
            </div>
          </div>
          <div class="order-bill">
            <div class="checkout__order">
              ...
              <?php if (isset($_SESSION['cart'])): ?>
                <button type="submit" class="site-btn" id="btn-pay">Thanh toán <span
                    class="btn-pay"><?= $total_new_price ?></span></button>
              <?php endif ?>
            </div>
          </div>
        </div>
